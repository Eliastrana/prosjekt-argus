...
Målet for dagen var enkelt: få én Bris-prognose ut av det publiserte sjekkpunktet på eX3. Det målet ble ikke nådd, men alt som ligger foran datasteget er nå verifisert, og underveis dukket det opp flere ting som endrer planen.

## Tilgang

Tilgangen til eX3 tok lengre tid enn ventet. FortiClient-VPN-en som MET anbefaler lar seg ikke koble til: `remote.simula.no` svarer på port 443, men det som ligger der er et ACME-endepunkt for sertifikatfornyelse, ikke en SSL-VPN-portal. Klienten sender brukernavn og passord til en sertifikattjeneste, får et svar den ikke kan tolke, og rapporterer «Insufficient credential(s)». Feilmeldingen peker altså på feil årsak.
